...
public class MyFavoriteNeighbourRecyclerViewAdapter extends RecyclerView.Adapter<MyFavoriteNeighbourRecyclerViewAdapter.ViewHolder> {
    ...
    private GetIdNeighbour getIdNeighbour;
    public MyFavoriteNeighbourRecyclerViewAdapter(List<Neighbour> items,   GetIdNeighbour getIdNeighbour ) {
        mNeighbours = items;

        this. getIdNeighbour = getIdNeighbour;
    }
